...
class BlogRepository
{
    ...
    public function addNewTag($request)
    {
        ...
        $tag->short_description = $request['short_description'];
    ...
    public function updateTag($request)
    {
        if ($request['lang'] != null && $request['lang'] != 'en') {
            ...
            $tag_translation->name = $request['name'];
            $tag_translation->short_description = $request['short_description'];
    ...
    public function blogUpdate($request)
    {
        if ($request['lang'] != null && $request['lang'] != 'en') {
            ...
            $blog_translation->name = $request['name'];
    ...
    public function updateComment($request)
    {
        ...
        $comment->user_website = $request['user_website'];
        $comment->comment = $request['comment'];
