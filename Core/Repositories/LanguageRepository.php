...
class LanguageRepository
{
    ...
    public function changeStatus($id)
    {
        try {
            ...
            if ($language->code != 'en') {
                ...
                toastNotification('error', 'You can not change status of this language', 'Failed');
            }
    ...
    public function storeNewlanguage($request)
    {
        try {
            ...
            $lan->native_name = $request['native_name'];
            $lan->status = 1;
            $lan->save();
            DB::commit();
            return true;
    ...
    public function deleteLanguage($id)
    {
        try {
            ...
            if ($code == config('app.locale')) {
                toastNotification('error', 'Can not delete default language', 'Failed');
            } else {
