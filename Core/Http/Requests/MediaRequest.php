...
class MediaRequest extends FormRequest{
    ...
    public function rules()
    {
        return [
            ...
            'watermark_image' => isset(request()->watermark_status)?'required':'',
            'watermark_image_position' => isset(request()->watermark_status)?'required':'',
            'water_marking_image_opacity' => isset(request()->watermark_status)?'required':'',
