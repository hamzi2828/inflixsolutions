                    ...
                    <div class="card-body p-0">
                        <div class="table-scroll">
                            <table class="text-nowrap dh-table">
                                <thead>
                                    <tr>
                                        <th>{{ translate('No.') }} <img src="../../assets/img/svg/table-down-arrow.svg"
                                                alt="" class="svg"></th>
                                        <th>{{ translate('Template') }} <img src="../../assets/img/svg/table-down-arrow.svg"
                                                alt="" class="svg">
                                        </th>
...
@section('custom_scripts')
    ...
    <script>
        ...
        function logoAndFooter(content) {
            "use strict";
            let system_logo = "{{ getFilePath(getGeneralSetting('white_background_logo')) }}"
