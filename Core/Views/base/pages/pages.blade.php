            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                    ...
                    <div class="filter_button row mb-4 pl-3">
                        ...
                        <a href="{{ route('core.page') . '?status=mine' . $if_search }}" class="btn sm btn-dark sm mx-1 my-2">
                        ...
                        <a href="{{ route('core.page') . '?status=schedule' . $if_search }}" class="btn sm btn-info mx-1 my-2">
                            {{ translate('Scheduled') }}({{ count(getPage([['tl_pages.publish_at', '>', currentDateTime()]], $search)) }})</a>

                        <a href="{{ route('core.page') . '?status=draft' . $if_search }}" class="btn sm btn-warning mx-1 my-2">
                            {{ translate('Drafts') }}({{ count(getPage([['tl_pages.publish_status', '=', config('settings.page_status.draft')]], $search)) }})</a>

                        <a href="{{ route('core.page') . '?status=trash' . $if_search }}" class="btn sm btn-danger mx-1 my-2">
                                ...
                                @foreach ($pages as $page)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="/page-preview?page={{ $page->permalink }}"
                                                    target="_blank">{{ $tlpage->translation('title', getLocale()) }}</a>
                                            @endif
                                        </td>
                                        <td>
