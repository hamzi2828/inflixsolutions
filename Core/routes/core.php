...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::middleware(['can:Manage Menus', 'menu.maintain'])->group(function () {
        ...
        Route::get('tree-view-data', [MenuController::class, 'treeViewData'])->name('core.tree.view.data');
    ...
    Route::get('/update-system', [SystemUpdateController::class, 'updateSystem'])->name('core.update.system');
    Route::post('/update-database', [SystemUpdateController::class, 'updateDatabase'])->name('core.update.database');
});
