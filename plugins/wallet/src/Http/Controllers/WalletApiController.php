...
class WalletApiController extends Controller
{
    ...
    public function storeOfflinePayment(OfflineRechargeRequest $request)
    {
        ...
        if ($request->has('transaction_image') && $request['transaction_image']) {
            ...
            $folder_name = "wallet-transaction-docs/" . date("Y") . "/" . date("M");;
            $transaction_image = saveFileInStorage($image, $file_name_to_store, $folder_name, $file_extension, config('settings.media_type.system'));
        }
