            ...
            <div class="card mb-30">
                ...
                <div class="card-body text-center">
                    @if (isActivePluging('carrier'))
                        <a href="{{ route('plugin.carrier.list') }}" class="btn-link">Manage 3rd party carriers</a>
                    @else
                        <p class="black">To enable 3rd party carrier shipping, activate carrier plugin <a
                                href="{{ route('core.plugins.index') }}" class="btn-link">from
                                here.</a></p>
                    @endif
                </div>
            </div>
