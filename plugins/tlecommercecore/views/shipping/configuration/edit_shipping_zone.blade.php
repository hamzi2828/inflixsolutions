     ...
     <div class="form-row mb-20">
         <div class="col-sm-12 edit-location-box">
             ...
             <div class="d-flex justify-content-center loader">
                 <img src="{{ asset('/public/loader.svg') }}" alt="" width="40px" height="auto">
             </div>
         </div>
 ...
 <script>
     (function($) {
          ...
          * 
          **/
         $('.edit-location-box').on('scroll', function() {
         ...
         $('.update-zone').click('on', function(e) {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.tlcommercecore.shipping.profile.zones.update') }}',
                 success: function(response) {
                     location.reload();
                 },
