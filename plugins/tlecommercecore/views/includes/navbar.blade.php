         ...
         <ul class="nav sub-menu">
             ...
             @if (auth()->user()->can('Manage All Products'))
                 <li class="{{ Request::routeIs(['plugin.tlcommercecore.product.list']) ? 'active ' : '' }}">
                     <a href="{{ route('plugin.tlcommercecore.product.list') }}">{{ translate('All Products') }}</a>
                 </li>
             @endif
 ...
 @if (auth()->user()->can('Manage Inhouse Orders') ||
     ...
     <li
         class="{{ Request::routeIs($order_pickup_point_active_link_file_links, ['plugin.tlcommercecore.orders.inhouse']) ? 'active sub-menu-opened' : '' }}">
         <a href="#">
 ...
 @if (auth()->user()->can('Manage Taxes') ||
     ...
     <li
         class="{{ Request::routeIs(['plugin.tlcommercecore.ecommerce.edit.currency', 'plugin.tlcommercecore.ecommerce.add.currency', 'plugin.tlcommercecore.ecommerce.all.currencies', 'plugin.tlcommercecore.ecommerce.configuration', 'plugin.tlcommercecore.ecommerce.settings.zone.taxes', 'plugin.tlcommercecore.products.share.options', 'plugin.tlcommercecore.ecommerce.settings.taxes.list']) ? 'active sub-menu-opened' : '' }}">
         <a href="#">
         ...
         <ul class="nav sub-menu">
             @if (auth()->user()->can('Manage Taxes'))
                 <li
                     class="{{ Request::routeIs(['plugin.tlcommercecore.ecommerce.settings.zone.taxes', 'plugin.tlcommercecore.ecommerce.settings.taxes.list']) ? 'active ' : '' }}">
                     <a
                         href="{{ route('plugin.tlcommercecore.ecommerce.settings.taxes.list') }}">{{ translate('Taxes') }}</a>
                 </li>
             @endif
