                            ...
                            <div class="product-list-item mb-20 d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <span
                                            class="c3 bold font-14">{{ currencyExchange($product->orders_sum_unit_price * $product->orders_sum_quantity) }}</span>
                                    </div>
                                </div>
                                <p class="font-14">
                            ...
                            <div class="product-list-item mb-20 d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <span
                                            class="c3 bold font-14">{{ currencyExchange($category['total_sales']) }}</span>
                                    </div>
                                </div>
                                <p class="font-14">
                            ...
                            <div class="product-list-item mb-20 d-flex justify-content-between align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <span
                                            class="c3 bold font-14">{{ currencyExchange($brand['total_sales']) }}</span>
                                    </div>
                                </div>
                                <p class="font-14">
