    ...
    <div class="row">
        <div class="col-12">
            ...
            <div
                ...
                <div
                    class="invoice-header-right d-flex align-items-center justify-content-around justify-content-sm-end mt-3 mt-sm-0">
            ...
            <div class="bg-white invoice-pd mb-30">
                <div class="row">
                    ...
                    <div class="col-12 d-flex filter-area justify-content-between mb-20 px-2">
                        @if ($order_details->adminCancelOrAcceptOrder() == config('settings.general_status.active'))
    ...
    <div id="order-shipping-label-modal" class="order-shipping-label-modal modal fade show" aria-modal="true"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <form id="order-status-update-form" method="POST"
    ...
    <div id="order-invoice-print-modal" class="order-invoice-print-modal modal fade show" aria-modal="true"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <form id="order-status-update-form" method="POST"
                        action="{{ route('plugin.tlcommercecore.orders.print.invoice') }}">
                        @csrf
                        <p class="text-error"></p>
                        <input type="hidden" name="order_id" value="{{ $order_details->id }}">
                        <!--Product checkbox-->
