...
use Plugin\TlcommerceCore\Http\Controllers\Api\OrderController;
...
Route::group(['prefix' => 'v1/ecommerce-core'], function () {
     ...
     * /api/v1/ecommerce-core
     */
    Route::get('checkout/configuration', [OrderController::class, 'checkoutConfiguration']);
    //Attachment
    ...
    Route::get('active-payment-methods', [OrderController::class, 'activePaymentMethods']);
