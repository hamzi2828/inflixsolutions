...
<head>
    ...
    <meta name="brand_name" content="Tl ecommerce" />
    <link rel="canonical" href="https://www.themelooks.com/" />
    <meta property="og:url" content="https://www.themelooks.com/" />
    <meta name="twitter:domain" content="https://www.themelooks.com/" />
    <meta property="fb:pages" content="163059227060505" />
    <meta property="og:site_name" content="tlcommerce" />
    <meta name="twitter:site" content="@tlcommerce" />
    <meta name="apple-mobile-web-app-title" content="Tl ecommerce" />
...
<body class="antialiased">
    ...
    @if (isActivePluging('tlecommercecore'))
        <script src="{{ asset('/themes/tlcommerce/public/js/main.js?v=112') }}"></script>
    @endif
</body>
