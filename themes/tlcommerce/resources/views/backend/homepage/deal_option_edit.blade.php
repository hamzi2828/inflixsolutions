         ...
         <div class="tab-content" id="myTabContent">
                 ...
                 <div class="form-row mb-20">
                     ...
                     <div class="col-sm-12">
                         <select class="theme-input-style" name="background_position">
                             ...
                             <option value="revert-layer" @selected(getHomePageSectionProperties($details->id, 'background_position') == 'revert-layer')>
             ...
             <div class="tab-pane fade" id="button" role="tabpanel" aria-labelledby="button-tab">
                 ...
                 <div class="form-row mb-20">
                     ...
                     <div class="col-sm-12">
                         <div class="input-group addon">
                             <input type="text" name="btn_bg_hover_color"
                 ...
                 <div class="form-row mb-20">
                     ...
                     <div class="col-sm-12">
                         <div class="input-group addon">
                             <input type="text" name="btn_border_color"
                                 class="color-input form-control style--two" placeholder="#fffff"
