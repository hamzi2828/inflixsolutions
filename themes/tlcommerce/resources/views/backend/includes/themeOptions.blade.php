...
@if (auth()->user()->can('Manage Theme General settings') ||
        ...
        auth()->user()->can('Manage Slider Settings')|| auth()->user()->can('Manage Widget'))
    <li
        class="{{ Request::routeIs(['theme.tlcommerce.home.page.sections.new', 'theme.tlcommerce.home.page.sections', 'theme.tlcommerce.sliders.edit', 'theme.tlcommerce.sliders.new', 'theme.tlcommerce.sliders', 'theme.tlcommerce.options']) ? 'active sub-menu-opened' : '' }}">
        <a href="#">
        ...
        <ul class="nav sub-menu">
            ...
            @if (auth()->user()->can('Manage Home Page Builder'))
                <li class="{{ Request::routeIs(['theme.tlcommerce.home.page.sections']) ? 'active ' : '' }}">
                    <a
                        href="{{ route('theme.tlcommerce.home.page.sections') }}">{{ translate('Home Page Builder') }}</a>
                </li>
            @endif
