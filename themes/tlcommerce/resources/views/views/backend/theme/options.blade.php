...
@section('main_content')
    ...
    <div class="theme-option-container">
        <form action="{{ route('theme.tlcommerce.save.option.form') }}" method="post" enctype="multipart/form-data" id="themeOptionForm">
            @csrf
            ...
            <div class="theme-option-sticky d-flex justify-content-end bg-white border-top2 p-3">
                <div class="theme-option-action_bar">
                    ...
                    <input type="submit" class="btn btn-info sm" name="reset_section"
                        value="{{ translate('Reset Section') }}">
                    <input type="submit" class="btn btn-info sm" name="reset_all"
                        value="{{ translate('Reset All') }}" >
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <button class="btn long mt-2 btn-danger"
...
@section('custom_scripts')
    ...
    {{-- Code editor --}}
    <script src="https://unpkg.com/ace-builds@1.6.0/src-min-noconflict/ace.js" type="text/javascript" charset="utf-8"></script>
