<template>
  <!-- Ad Section -->
  <section class="mb-15 mt-15 ads-section bg-white" :style="cssVars">
    <div class="custom-container2">
      <div class="row">
        ...
        >
          <a :href="ad.url" target="_blank" class="d-block mb-30 mh-255">
            <v-lazy-image class="w-100 lmh-255" :src="ad.image" :alt="index" />
          </a>
        </div>
      </div>
    </div>
