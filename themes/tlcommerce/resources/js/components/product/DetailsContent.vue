<template>
  ...
  <div class="product-details-content">
    ...
    <!-- Rating -->
    <div
      class="align-items-center d-flex mb-20 rating-wrap"
    ...
    >
      ...
      >
        ...
        <h4 class="ms-3 mb-0 c1">{{ product.rating }}</h4>
      </div>
      <div class="rating-text-wrap flex-wrap d-flex">
    ...
    <!-- End Rating -->
    <!-- Summary -->
    <div v-if="product.summary" class="product-summary-section">
    ...
    <!--Price Range-->
    <div
      class="product-price price-range mt-4"
      v-if="
    ...
    <!-- End  Price Range-->
    <!-- Total Price -->
    <div class="product-price unit-price mt-4">
    ...
    <!-- End Total Price -->
    <!-- Option Choice Form -->
    <div class="option-choice-form mt-4">
      <!--Variant options-->
    ...
    <!-- Quantity -->
    <div class="mt-20 product-details-quantity">
    ...
    <!--Attachment-->
    <div
      class="mt-20 product-details-attachment-area"
      v-if="product.attatchment_title != null"
    >
      <h6 class="mb-1 text-capitalize">{{ product.attatchment_title }}</h6>
      <input
        type="file"
        name="attach"
        ref="attachment"
    ...
    <!--End attachment-->
    <!--Action buttons-->
    <hr class="mt-4 bg-secondary mb-30" />
...
export default {
  ...
  methods: {
    ...
    addToCompare() {
      this.$store
        .dispatch("addItemToCompareItems", this.product.id)
        .then((response) => {
          this.$toast.success(this.$t("Item has been added to compare list"));
        });
    },
  },
};
