            ...
            <div class="custom-container2">
                <div class="row">
                    <div :class="blogsListLayoutClass">
                        ...
                        >
                            ...
                            <header class="entry-header">
                                ...
                                >
                                    ...
                                    >
                                        <li
                                            v-if="singleBlogPageStyle.date == 1"
                                        >
                            ...
                            <footer class="entry-footer">
                                <div
                                    class="row border-top border-bottom pt-3 pb-3"
                                >
                                    <div class="col-lg-6">
                                        <!-- Tags -->
                                        <div class="entry-tags">
                                            <ul class="list-inline media">
                                                <li>{{ $t("Tags:") }}</li>
                                                <li
                                                    class="media-body d-flex flex-wrap"
                                                    v-if="blog.tag != null"
                                                >
                                                    <template
                                                        v-for="(
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="entry-categories">
                                            <ul class="list-inline media">
                                                ...
                                                <li
                                                    class="media-body d-flex flex-wrap"
                                                    v-if="blog.category != null"
                                                >
                                                    <template
                                                        v-for="(
                                                            cat, index
                                                        ) in blog.category_list"
                                                    >
                                                        <a
                                                            :href="
                                                                '/blog/category/' +
                        ...
                        <!-- Related Post -->
                        <div class="related-post pt-50">
                            <h2>{{ $t("You may like it") }}</h2>
                        ...
                        <!--Blog Comments-->
                        <div class="comments-area mt-50" id="comment-list-01">
                            <div>
                                <v-runtime-template
                        ...
                        >
                            <template
                                v-if="
                                    (commentSettings.comment_registration ==
                                        1 &&
    ...
    computed: mapState({
        ...
        blogsListLayoutClass() {
            if (
                ...
                if (
                    this.singleBlogPageStyle.single_blog_page_layout ==
                    "full_layout"
                ) {
                    return "col-lg-12";
                }
            ...
            axios
                ...
                .then((response) => {
                    if (response.data.success) {
                        ...
                        this.singleBlogPageStyle =
                            response.data.singleBlogPageStyle;
                    }
                })
                .catch((error) => {});
        },
